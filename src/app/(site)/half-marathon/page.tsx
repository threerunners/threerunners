...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getHubPage('half-marathon')
  return {
  ...
  return (
    <>
      ...
      <div className="wrap" style={{ paddingBottom: 60 }}>
        ...
        <div style={{ marginBottom: 56 }}>
          <FAQAccordion heading="Common questions" subheading="Things we get asked about half marathon shoes." faqs={page.faqs} variant="hub" />
        </div>
